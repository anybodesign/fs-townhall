						...
						<div class="inner">
							...
							<?php 	
								if ( is_home() && ! is_front_page() ) {
									...
									printf( esc_html__( 'Search Results for: %s', 'fs-townhall' ), '<span class="search-term">' . get_search_query() . '</span>' );
								} else if ( is_404() ) {
									esc_html_e( 'Oops! That page can&rsquo;t be found', 'fs-townhall' );
								} else {
									the_title(); 
								}
							?>
