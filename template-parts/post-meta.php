...
?>
							<div class="post-meta">
								...
								<p class="meta-infos">
									<?php esc_html_e( 'Posted ', 'fs-townhall' ); ?>
									<?php if ( $date != false ) { 
										esc_html_e( 'on&nbsp;', 'fs-townhall' ); 
										echo the_time( get_option('date_format') ); 
									} ?>
									<?php if ( $author != false ) {
										esc_html_e( 'by&nbsp;', 'fs-townhall' ); the_author(); 
									} ?>
									<?php if ( $cat != false ) {
										esc_html_e( 'in&nbsp;', 'fs-townhall' ); the_category(', '); 
									} ?>
								</p>
								<?php } ?>
								...
								<p class="meta-comments">
									<a href="<?php the_permalink() ?>#comments">
										<?php printf( _n( '%s comment', '%s comments', $comment, 'fs-townhall' ), $comment ); ?>
									</a>
								</p>
		    					<?php endif; ?>
							</div>